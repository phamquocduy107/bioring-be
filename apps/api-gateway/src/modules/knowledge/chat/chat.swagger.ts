          ...
          messages: [
            {
              ...chatMessageExample,
              role: 'user',
              content: 'Gợi ý nhẫn cầu hôn dưới 10 triệu',
              intent: 'RING_RECOMMENDATION',
              type: '',
              sources: [],
              suggestedProducts: [],
            ...
            },
            {
              ...chatMessageExample,
              role: 'assistant',
              content: 'Dựa trên ngân sách của bạn, mình gợi ý...',
              intent: 'RING_RECOMMENDATION',
              type: 'ring_recommendation',
              sources: [],
              suggestedProducts: [
                {
                  ...
                  price: 1500000,
                  material: 'silver',
                  reason: 'Phù hợp ngân sách ≤ 10000000',
                },
              ],
              suggestedPackages: [],
              productFilters: { purpose: 'engagement', budgetMax: 10000000 },
              missingFields: [],
              clarificationData: null,
              suggestionChips: [],
            },
